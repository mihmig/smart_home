...
* Для уменьшения количества столбцов напряжение батарей датчиков хранить в отдельной таблице (и только при изменении значения)
* Графики температуры - удобное масштабирование, прогноз, "что было год назад"
### Прочее
